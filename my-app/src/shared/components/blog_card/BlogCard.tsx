  ...
  return (
    <div className="group rounded overflow-hidden ">
      <div className="relative overflow-hidden ">
        ...
        alt="art cover" loading="lazy" width="1000" height="667" className="h-50 w-full object-cover object-top transition duration-500 group-hover:scale-105 rounded-none"/>
      </div>
